...
namespace TextRPG__ver._2025_
{
    public class StoreScene : Scene
    {
        ...
        public void DisplayItems()
        {
            ...
            {
                // 갑옷
               new Armor (2, "수련자 갑옷", 2, "얇은 가죽으로 만들어진 기본 방어구입니다.", 120),
               new Armor (2, "무쇠갑옷", 5, "튼튼한 무쇠 갑옷입니다.",   200),
               new Armor (2, "스파르타의 갑옷", 9, "스파르타 전사의 전설적 갑옷입니다.",  300),

               //무기
               new Weapon(1, "낡은 검", 2, "쉽게 볼 수 있는 낡은 검입니다.", 100),
               new Weapon(1, "청동 도끼", 5, "어디선가 쓰던 청동 도끼입니다.", 200),
               new Weapon(1, "스파르타의 창", 7, "스파르타 전사들이 쓰던 전설의 창입니다.", 300)
            });
        }
     }
}
